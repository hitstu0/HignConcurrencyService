package com.example.loginservice.Mybatis.SqlSessionFactory;
...
public class SqlSessionBuilder implements CommandLineRunner{
    ...
    private void addAlias() {
        ...
        DataSource.addAlias("userInfo", User.class);
        DataSource.addAlias("userLoginInfo", UserLoginInfo.class);
    }
